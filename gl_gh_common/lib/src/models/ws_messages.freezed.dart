...
mixin _$WsResponseMessage {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function() serving,
  ...
  @optionalTypeArgs
  TResult map<TResult extends Object?>({
    required TResult Function(_Serving value) serving,
  ...
  @optionalTypeArgs
  TResult? mapOrNull<TResult extends Object?>({
    TResult? Function(_Serving value)? serving,
...
/// @nodoc
abstract class _$$_ServingCopyWith<$Res> {
  factory _$$_ServingCopyWith(
          _$_Serving value, $Res Function(_$_Serving) then) =
      __$$_ServingCopyWithImpl<$Res>;
}

/// @nodoc
class __$$_ServingCopyWithImpl<$Res>
    extends _$WsResponseMessageCopyWithImpl<$Res, _$_Serving>
    implements _$$_ServingCopyWith<$Res> {
  __$$_ServingCopyWithImpl(_$_Serving _value, $Res Function(_$_Serving) _then)
      : super(_value, _then);
}
...
class _$_Serving implements _Serving {
  const _$_Serving({final String? $type}) : $type = $type ?? 'serving';

  factory _$_Serving.fromJson(Map<String, dynamic> json) =>
      _$$_ServingFromJson(json);
  ...
  @override
  String toString() {
    return 'WsResponseMessage.serving()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_Serving);
  }
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$_ServingToJson(
      this,
    );
  }
}

abstract class _Serving implements WsResponseMessage {
  const factory _Serving() = _$_Serving;
